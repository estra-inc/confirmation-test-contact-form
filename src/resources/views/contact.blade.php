    ...
    <form action="confirm" method="post">
      ...
      <div class="contact-form__group">
        ...
        <div class="contact-form__tel-inputs">
          <input class="contact-form__input contact-form__tel--input" type="tel" name="tel_1" id="tel" value="{{ old('tel_1') }}" placeholder="080">
          <span>-</span>
          <input class="contact-form__input contact-form__tel--input" type="tel" name="tel_2" value="{{ old('tel_2') }}" placeholder="1234">
          <span>-</span>
          <input class="contact-form__input contact-form__tel--input" type="tel" name="tel_3" value="{{ old('tel_3') }}" placeholder="5678">
        </div>
        <p class="contact-form__error-message">
          @if ($errors->has('tel_1'))
            {{$errors->first('tel_1')}}
